# -*- coding: utf-8 -*-
"""Tutorial_Translation.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1-0bqZVJ7fP0u4Z7j8JG4E5igYv97xsSJ
...
# Packakge installations

Let us first install the needed packages to run the notebook, with  pip:
